...
while True:
    ...
    video_list_input = input("Veuillez fournir la liste des vidéos (séparées par des virgules) : ")
    ...
    for video_url in video_list:
        try:
            ...
            if captions:
                ...
                text_chunks = [all_text[i:i+4096] for i in range(0, len(all_text), 4096)]
            ...
            print(f"Une erreur s'est produite lors de la récupération des sous-titres pour la vidéo {video_url}: {str(e)}")

    while True:
        choix = input("Avez-vous d'autres vidéos dont extraire les sous-titres ? Tapez O pour oui, N pour non : ")
        if choix.lower() == 'o' or choix.lower() == 'n':
            break
        else:
